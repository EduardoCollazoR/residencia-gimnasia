        ...
        <div class="col-lg-4 mt-lg-0 ">
          ...
          <form action=" " method="post" role="form" class="form">
            <div class="form-group">
              ...
              <input type="text" name="opcion" class="form-control" id="opcion" placeholder="SI/NO" />
            ...
            <div class=" form-group">
              <label class="control-label">¿Has tenido alguna lesion?</label>
            ...
            <div class=" form-group">
              <label class="control-label">¿Llevaste rehabilitacion debido a la lesion?</label>
              <input type="text" class="form-control" name="rehabilitacion" id="rehabilitacion" placeholder="SI/NO" />
              <div class="validate"></div>
            </div>
            <div class=" form-group">
